...
public class MainActivity extends Activity implements OnLocationUpdatedListener, OnActivityUpdatedListener, OnGeofencingTransitionListener {
    ...
    private void startLocation() {
        ...
        GeofenceModel mestalla = new GeofenceModel.Builder("1").setTransition(Geofence.GEOFENCE_TRANSITION_ENTER).setLatitude(10.015896).setLongitude(76.632427).setRadius(5).build();
        smartLocation.geofencing().add(mestalla).start(this);
        mestalla = new GeofenceModel.Builder("2").setTransition(Geofence.GEOFENCE_TRANSITION_ENTER).setLatitude(10.015149).setLongitude(76.632427).setRadius(5).build();
        smartLocation.geofencing().add(mestalla).start(this);
